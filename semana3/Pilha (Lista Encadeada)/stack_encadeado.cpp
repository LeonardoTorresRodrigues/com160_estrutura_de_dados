...
Stack::Stack()
{
    structure = NULL; // Estamos implementando o construtor Stack e inicializando como NULL.
}
...
Stack::~Stack()
{
    ...
    {
        tempPtr = structure;         // tempPtr apontará para o elemento que será deletado.
        structure = structure->next; // structure passará para o elemento seguinte.
        delete tempPtr;
    }
}
